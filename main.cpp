...
int main(){
    ...
    std::cout<< "Relative numerical integration error for radiative calulation =       " <<ppp.err_r  <<std::endl;
    std::cout<< "Relative numerical integration error for non-radiative calulation =   " <<ppp.err_nr  <<std::endl;
    return 0;
}
